    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 pointer-events-none">
            <div className={`w-82 px-6 pt-6 pb-6 rounded-2xl bg-black/25 backdrop-blur-sm
                ...
                <div className={`transition-all duration-500 ease-in-out overflow-hidden px-1 pb-1
                    ${isOtp ? "opacity-100 mt-4 max-h-40" : "opacity-0 mt-0 max-h-0"}`}>
                ...
                <div className="px-1 mt-6 flex justify-between items-center">
                    ...
                    {isOtp && (
                        <button
                            ...
                            className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white text-sm font-semibold py-2 px-4 rounded-lg transition-all duration-500 ease-out">
                            Continue
                        </button>
                    )}
                </div>
